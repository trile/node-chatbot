...
const Messages = {
  ...
  en_US : {
    ...
    setphone_button_correct: 'Correct',
    addphone: 'Thank you!',
    updatephone: assemble('Thank you, we have updated your new phone number as ${phone_number}. Is this correct or you want to change?', 'phone_number'),
  ...
  vi_VN : {
    ...
    setphone_button_correct: 'Chính xác',
    addphone: 'Cám ơn bạn',
    updatephone: assemble('Cảm ơn bạn, chúng tôi đã cập nhật số điện thoại mới của bạn là ${phone_number}. Số này chính xác rồi hay bạn muốn thay đổi?', 'phone_number'),
